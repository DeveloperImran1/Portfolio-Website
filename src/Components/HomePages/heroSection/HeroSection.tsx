...
export default function HeroSection() {
  ...
  return (
    <div id="" className={`relative flex flex-col justify-center items-center gap-2 mx-auto mt-[40px] md:mt-[70px]  `}>
      ...
      <Image height="600" width="600" className="w-[150px] lg:w-[180px] h-[150px] lg:h-[180px] z-10 rounded-full" src="https://i.postimg.cc/PxXKg8zy/Developer-Imran-Profile.png" alt="Profile Image" />
      <span className=" text-[30px] md:text-[40px] font-bold text-center flex justify-center items-center mt-3 ">
        Hi <Image height="600" width="35" alt='Imran' className="" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736266015/Hi_ut0xb5.gif"  />
      ...
      <div className="grid grid-flow-col gap-4">
        <Link target='_blank' href="https://www.facebook.com/imran9066588" className="hover:text-[#076aa5] rounded-full shadow-[0px_2px_8px_0px_rgba(99,99,99,0.4)] duration-300 hover:scale-150 h-8 w-8 flex justify-center items-center">
          <FaFacebookF className="text-blue-600 hover:text-[#076aa5] text-[16px]" />
        </Link>
        <Link target='_blank' href="https://www.linkedin.com/in/developerimran1122/" className="hover:text-[#076aa5] rounded-full shadow-[0px_2px_8px_0px_rgba(99,99,99,0.4)] duration-300 hover:scale-150 h-8 w-8 flex justify-center items-center">
          <FaLinkedin className="text-blue-600 hover:text-[#076aa5] text-[16px]" />
        </Link>
        <Link target='_blank' href="https://github.com/DeveloperImran1" className="hover:text-[#076aa5] rounded-full shadow-[0px_2px_8px_0px_rgba(99,99,99,0.4)] duration-300 hover:scale-150 h-8 w-8 flex justify-center items-center">
          <FaGithub className="text-blue-600 hover:text-[#076aa5] text-[16px]" />
        </Link>
      </div>
      <div className="flex gap-3 mt-3">
        <a href="/Resume.pdf" target="_blank" rel="noopener noreferrer"  download="Resume">
      ...
      <Image height="600" width="600" className="h-[60px] w-[60px] rounded-full  animate-spin absolute top-[-4%] right-[15%]" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260770/reactjs_fq9myl.png" alt="" />
      <Image height="600" width="600" className="animate-scale h-[30px] w-[30px]  rounded-full  absolute  top-[24%] right-[15%]" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260776/mongodb_rxsmnt.png" alt="" />

      <Image height="600" width="600" className="h-[40px] w-[40px] rounded-full absolute top-[-4%] left-[15%]" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260769/javascript_lubfvy.png" alt="" />

      <Image height="600" width="600" className="animate-scale h-[30px] w-[30px]  rounded-full absolute top-[24%] left-[15%]" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260783/expressjs_zqjbld.png" alt="" />
