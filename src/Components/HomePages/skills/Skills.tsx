                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-5" >
                            ...
                            <div onMouseEnter={handleClick1} onMouseLeave={handleClick1}>
                                <ReactCardFlip isFlipped={isFlipped1} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce  transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260774/html5_xfw2yn.png" alt="HTML" />
                            ...
                            <div onMouseEnter={handleClick2} onMouseLeave={handleClick2}>
                                <ReactCardFlip isFlipped={isFlipped2} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260776/css3_wczxcl.png" alt="CSS" />
                            ...
                            <div onMouseEnter={handleClick3} onMouseLeave={handleClick3}>
                                <ReactCardFlip isFlipped={isFlipped3} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260771/tailwindcss_anjt42.png" alt="Tailwind CSS" />
                            ...
                            <div onMouseEnter={handleClick4} onMouseLeave={handleClick4}>
                                <ReactCardFlip isFlipped={isFlipped4} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260769/javascript_lubfvy.png" alt="Javascript" />
                            ...
                            <div onMouseEnter={handleClick5} onMouseLeave={handleClick5}>
                                <ReactCardFlip isFlipped={isFlipped5} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260770/reactjs_fq9myl.png" alt="React JS" />
                            ...
                            <div onMouseEnter={handleClick16} onMouseLeave={handleClick16}>
                                <ReactCardFlip isFlipped={isFlipped16} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260784/nextjs-icon-512x512-11yvtwzn_1_dluzow.png" alt="NextJs" />
                                    </div>
                            ...
                            <div onMouseEnter={handleClick17} onMouseLeave={handleClick17}>
                                <ReactCardFlip isFlipped={isFlipped17} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260787/logo-sm_1_gyfe4s.png" alt="Next Auth" />
                            ...
                            <div onMouseEnter={handleClick18} onMouseLeave={handleClick18}>
                                <ReactCardFlip isFlipped={isFlipped18} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260780/Firebase-logo-02_1_kwxz25.png" alt="Firebase" />
                            ...
                            <div onMouseEnter={handleClick19} onMouseLeave={handleClick19}>
                                <ReactCardFlip isFlipped={isFlipped19} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260788/socket-io-logo-icon-144874_yl1hpb.webp" alt="Socket Io" />
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-5" >
                            ...
                            <div onMouseEnter={handleClick6} onMouseLeave={handleClick6}>
                                <ReactCardFlip isFlipped={isFlipped6} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260777/nodejs_p6l5f9.png" alt="Node JS" />
                            ...
                            <div onMouseEnter={handleClick7} onMouseLeave={handleClick7}>
                                <ReactCardFlip isFlipped={isFlipped7} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260783/expressjs_zqjbld.png" alt="Express JS" />
                            ...
                            <div onMouseEnter={handleClick8} onMouseLeave={handleClick8}>
                                <ReactCardFlip isFlipped={isFlipped8} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260776/mongodb_rxsmnt.png" alt="MongoDB" />
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-5" >
                            ...
                            <div onMouseEnter={handleClick9} onMouseLeave={handleClick9}>
                                <ReactCardFlip isFlipped={isFlipped9} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260774/github_qfw6tf.png" alt="Github" />
                            ...
                            <div onMouseEnter={handleClick10} onMouseLeave={handleClick10}>
                                <ReactCardFlip isFlipped={isFlipped10} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260773/git_orugy2.png" alt="Git" />
                            ...
                            <div onMouseEnter={handleClick11} onMouseLeave={handleClick11}>
                                <ReactCardFlip isFlipped={isFlipped11} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260771/npm_ripeco.png" alt="npm" />
                            ...
                            <div onMouseEnter={handleClick12} onMouseLeave={handleClick12}>
                                <ReactCardFlip isFlipped={isFlipped12} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260770/adobe-photoshop_qr10gt.png" alt="Adobe Photoshop" />
                            ...
                            <div onMouseEnter={handleClick13} onMouseLeave={handleClick13}>
                                <ReactCardFlip isFlipped={isFlipped13} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260769/figma_ufzidn.png" alt="Figma" />
                            ...
                            <div onMouseEnter={handleClick14} onMouseLeave={handleClick14}>
                                <ReactCardFlip isFlipped={isFlipped14} flipDirection="horizontal">
                                    ...
                                    <div className="bg-white    p-6 md:p-8 group  flex flex-col justify-center items-center space-y-3 my-transition h-[150px]  text-center ring-1 ring-ring-color overflow-hidden  rounded-br-3xl rounded-tl-3xl  transition-all duration-300 ease-in-out transform delay-200" >
                                        <Image height="600" width="600" className="size-[90px] animate-smoth-bounce transition-all duration-300 ease-in-out transform delay-200   group-hover:shadow-md p-2 rounded-xl object-cover overflow-hidden" src="https://res.cloudinary.com/dqdircc96/image/upload/v1736260768/pixso_kbcfsc.png" alt="" />
