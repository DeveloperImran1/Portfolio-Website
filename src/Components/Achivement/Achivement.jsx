            ...
            <div id="achived" className="bg-white  rounded-2xl " >
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-11 p-6 z-50 " >
                    ...
                    <div className="relative lg:max-w-[37vw]" >
                        ...
                        <p className="text-base my-3">Recognized for leadership excellence in Programming Hero's Endgame Program, showcasing exceptional team management, organizational skills, and innovative problem-solving, awarded among 500 students.</p>
