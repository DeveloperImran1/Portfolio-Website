...
//     React.useEffect(()=> {
//        const matchBlog = blogs.filter(blog => blog?._id == id);
//        setBlog(matchBlog?.[0])
//     } ,[id])
//     console.log("matches", blog)
...
//             </Helmet> */}
//             <div className="container flex flex-col w-full lg:max-w-[70%] p-6 mx-auto  rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800">
...
//                     <p>{blog?.content}</p>
//                     <p className="text-[19px] font-semibold mt-11 mb-2" >The Importance of</p>
...
//                     <p className="text-[19px] font-semibold mt-11 mb-2" >Exploring the World of Progressive</p>
...
const BlogsDetails = () => {
    ...
    const handleReview = (e) => {
        ...
        axiosPublic.patch(`/blogsComment/${blog?._id}`, reviewObj)
            .then(res => {
