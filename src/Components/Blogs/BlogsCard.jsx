                ...
                >
                    <SwiperSlide>
                        <div className="relative group">
                            ...
                            <img width={300} height={300} className="h-[300px] w-full rounded-lg bg-black/40" src={image?.[0] || 'https://source.unsplash.com/300x300/?macbook'} alt="Blog Cover Image" />
                    ...
                    <SwiperSlide>
                        ...
                        <div className="absolute left-4 right-4 top-4 flex items-center justify-between">
                            ...
                            <img width={300} height={300} className="h-[300px] w-full rounded-lg bg-black/40" src={image?.[1] || 'https://source.unsplash.com/300x300/?macbook'} alt="Blog Cover Image" />
                            <div className=" size-1 p-[3px]  flex justify-center items-center absolute top-3 right-1 group-hover:w-full group-hover:h-full group-hover:top-0 group-hover:right-0 group-hover:bg-blue-100/60 duration-500 transition-all">
                    ...
                    <SwiperSlide>
                        ...
                        <div className="absolute left-4 right-4 top-4 flex items-center justify-between">
                            ...
                            <img width={300} height={300} className="h-[300px] w-full rounded-lg bg-black/40" src={image?.[2] || 'https://source.unsplash.com/300x300/?macbook'} alt="Blog Cover Image" />
                            <div className=" size-1 p-[3px]  flex justify-center items-center absolute top-3 right-1 group-hover:w-full group-hover:h-full group-hover:top-0 group-hover:right-0 group-hover:bg-blue-100/60 duration-500 transition-all">
