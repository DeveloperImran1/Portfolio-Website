...
export default function Home() {
  return (
    <div id="home" className="flex flex-col justify-center items-center gap-2 mx-auto h-[100vh] min-w-[calc(100vw-220px)] " >
      <img className="w-[150px] h-[150px] rounded-full" src="https://i.ibb.co/C5j8rL3/Blue-Modern-Facebook-Profile-Picture.png" alt="Profile Image" />
      <h1 className="text-2xl font-bold">Hi, I am Imran. Front-End Web Developer</h1>
      ...
      <div className="flex flex-col items-center justify-center gap-2 mt-[60px] cursor-pointer" >
        <a>Scrool Down</a>
        <a href="#skills">
